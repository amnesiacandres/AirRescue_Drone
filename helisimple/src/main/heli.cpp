...
int main(int argc,char* argv[])
{
	...
	while (stop == false){
		...
		//fprintf(stdout,"Largest blob %i %i :: Yaw signal %i \n",yaw);
        //fprintf(stdout,"Largest blob %i %i :: Yaw signal %f \n\n",pos.x,pos.y,yaw);
		//image is captured
		...
		yaw = 500*(pos.x-160); //uncomment to make the drone to turn towards a colored target
